...
<?php $this->assign('title', __('Agendas') ); ?>
...
<div class="card card-pink card-outline">
    <div class="card-header d-sm-flex">
        ...
        <div class="card-toolbox">
            ...
            <?= $this->Html->link(__('Cadastrar Agenda'), ['action' => 'add'], ['class' => 'btn bg-maroon btn-sm']) ?>
        </div>
    </div>
    <!-- /.card-header -->
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="actions">
                        ...
                        <?= $this->Form->postLink(__('<i class="fa fa-trash"></i>'), ['action' => 'delete', $agenda->id_agenda], ['class' => 'btn btn-sm bg-purple', 'escape' => false, 'confirm' => __('Deseja realmente excluir agenda do dia {0}?', $agenda->data->i18nFormat('dd/MM/Y'))]) ?>
                    </td>
                </tr>
                <?php endforeach; ?>
            </tbody>
